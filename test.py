...
def main():
    ...
    NEW_SURF, NEW_RECT = makeText(' Player vs AI ', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 365, WINDOWHEIGHT - 60)
    NEW_SURF2, NEW_RECT2 = makeText(' Multiplayer ', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 360, WINDOWHEIGHT - 100)
    board = [BLANK] * 9
    game_over = False
    x_turn = True
...
#Message Box code___________________________________________________________
            
            if result == PLAYER_X: 
                messagebox.askretrycancel("X wins","try again?")  
            elif result == PLAYER_O:
                messagebox.askretrycancel("O wins","try again?")
            elif result == DRAW_GAME:
                messagebox.askretrycancel("DRAW!!!","try again?")
